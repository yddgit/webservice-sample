 ...
 * 
 */
@WebServiceClient(name = "userService", targetNamespace = "http://service.project.my.com/user", wsdlLocation = "http://localhost:8080/webservice-sample/userService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/webservice-sample/userService?wsdl");
